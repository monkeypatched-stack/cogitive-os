...
from services.orders.models.order_details import OrderDetailsCreate, OrderDetailsUpdate
...
async def create(db: AsyncIOMotorDatabase, data: OrderDetailsCreate) -> dict:
