...
COLLECTION = "shipping_information"
...
async def get_by_order_id(db: AsyncIOMotorDatabase, order_id: str) -> list[dict]:
    cursor = db[COLLECTION].find({"order_id": order_id})
    return [_serialize(doc) async for doc in cursor]


async def create(db: AsyncIOMotorDatabase, data: ShippingInformationCreate) -> dict:
