#!/bin/bash
# LEGACY (Thesis 14 prototype) — CognitiveOS Edge Actor Shutdown Script
#
# STATUS: stops the standalone EdgeActor prototype started by
# start_edge_actor_legacy_thesis14.sh — see that script's header. For the
# real edge deployment, use scripts/stop_actor.sh instead.
#
# Usage: ./scripts/stop_edge_actor_legacy_thesis14.sh <actor_id>
